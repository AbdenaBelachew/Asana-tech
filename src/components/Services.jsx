...
const services = [
  { icon: Laptop, title: 'Website Development', desc: 'Professional corporate websites and complex web apps designed to maximize your conversions and rank #1 on Google search.', accent: false },
    ...
    <section id="services" className="section-shell">
      <div className="section-inner">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="section-title">High-Performance Digital Solutions</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => {
            ...
            return (
              <div
                key={i}
                className="group glass-card p-8 flex flex-col hover:-translate-y-1.5"
              >
                <div className={`icon-box mb-6 group-hover:scale-105 ${s.accent ? 'icon-box-accent' : ''}`}>
                  <Icon size={22} />
                </div>
                <h3 className="text-lg font-extrabold text-slate-900 mb-2.5 group-hover:text-[#166804] transition-colors duration-300">
                  {s.title}
                </h3>
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center gap-1.5 text-xs font-bold text-[#166804] hover:text-[#1a7a05] transition-colors cursor-pointer group/btn"
                >
                  Request a Proposal
